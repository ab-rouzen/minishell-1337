...
/*   Updated: 2022/12/28 00:35:58 by imittous         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_print_expo_norm(t_env_list *tmp, char *cmd,
					t_list *cmd_list);
...
int				ft_find_oldpwd(char cwd[255], t_env_list *tmp,
					t_list *cmd_list);
...
/*####################      4_builtin_utils.c      ####################*/
int				ft_find_variable_norm(t_env_list *ms_list, char **str,
					char *cmd);
int				ft_find_variable(t_env_list *ms_list, char **str, char *cmd,
					int i);
int				ft_unset(t_env_list **ms_list, char **cmd, int i);
